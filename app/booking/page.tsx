  ...
  const validate = () => {
    ...
    if (currentStep === 4) {
      ...
      if (!formData.deliveryOption)
        e.deliveryOption = 'Please select an option.';
    }
    setErrors(e);
      ...
      <div className='min-h-screen bg-gray-100 flex items-center justify-center px-4 py-16'>
        <div className='bg-white rounded-2xl shadow-lg max-w-md w-full p-10 flex flex-col items-center gap-5 text-center'>
          ...
          <p className='text-sm text-gray-600 leading-relaxed'>
            Thank you, <strong>{formData.firstName}</strong>! Your appointment
            for <strong>{formData.serviceName}</strong> on{' '}
    ...
    <div className='min-h-screen bg-gray-100 py-8 px-4'>
      <div className='max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.08)]'>
        <div className='px-8 pt-10 pb-14 md:px-16'>
          <h1 className='text-3xl md:text-4xl font-extrabold text-blue-500 mb-3'>
            Book an Appointment
          </h1>
          <p className='text-base text-gray-500 leading-relaxed mb-10'>
            Use our simple booking assistant to schedule your service
            appointment.
          </p>
                ...
                <div className='border border-gray-200 rounded-xl overflow-hidden'>
                  {visibleServices.map((s) => (
                    <button
                      ...
                      className={
                        ...
                        (formData.serviceId === s.id
                          ? 'bg-yellow-50 border-l-4 border-l-[#F5C518] animate-pulse'
                    ...
                    >
                      ...
                      <span className='flex-1 text-base font-semibold text-[#1a2b4a]'>
                        {s.name}
                      </span>
                  ...
                  {!formData.showAllServices && services.length > 6 && (
                    ...
                    >
                      <span className='text-xl w-7 text-center text-gray-400'>
                        ···
                      </span>
          ...
          {currentStep === 4 && (
            <div className='mb-6'>
              ...
              <div className='flex flex-col gap-4'>
                ...
                <div>
                  <p className='text-sm font-bold text-[#1a2b4a] mb-3'>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    <button
                      ...
                      onClick={() =>
                        update(
                          'deliveryOption',
                          formData.deliveryOption === 'pickup' ? '' : 'pickup',
                        )
                      }
                      className={
