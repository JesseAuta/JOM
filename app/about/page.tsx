    ...
    <main className='w-full bg-gray-50 relative'>
      ...
      >
        ...
        <p className='text-gray-600 leading-relaxed max-w-3xl mx-auto'>
          At JOM Auto, we combine expertise, precision, and dedication to
          provide top-quality automotive services. Our team works daily to
          ensure every vehicle is handled with the highest standards of care and
          professionalism.
        </p>
      </motion.section>

      {/* --- HERO CARDS --- */}
      <section className='max-w-6xl mx-auto px-6 pt-0 pb-16 grid md:grid-cols-3 gap-8'>
